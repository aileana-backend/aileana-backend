const ENDPOINTS = {
	...
	DVA: {
		...
		GetDVA: (accountReference) => `/v2/bank-transfer/reserved-accounts/${accountReference}`,
		DeleteDVA: (accountReference) => `/v1/bank-transfer/reserved-accounts/reference/${accountReference}`,
		ListDVATransactions: `/v1/bank-transfer/reserved-accounts/transactions`,
		UpdateKYC: (accountReference) => `/v1/bank-transfer/reserved-accounts/${accountReference}/kyc-info`,
	},
