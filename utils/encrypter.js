...
function decryptText(encryptedData, secretKey) {
	...
	const ivHex = encryptedData.slice(-((AUTH_TAG_LENGTH + IV_LENGTH) * 2), -AUTH_TAG_LENGTH * 2) // before tag
	const encrypted = encryptedData.slice(0, -((AUTH_TAG_LENGTH + IV_LENGTH) * 2))
